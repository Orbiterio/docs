...
- `schema.sql`: proposed PostgreSQL schema, 16 tables / 211 columns; not a timestamped production migration.
...
- `rendered/`: generated synthetic previews, including placeholder capability URLs. No real contacts or invitations.
...
- The reference DDL creates all tables and 62 foreign keys on an isolated local PostgreSQL cluster with minimal external-key fixtures.
