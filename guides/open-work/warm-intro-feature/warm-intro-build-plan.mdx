...
<Note>
**Pending change from Deal Flow, September 26, 2026.** An introduction can also start from a deal. `introductions` gains an optional deal reference, and the Leverage Loop source fields, including `source_action_ref`, become optional. The tables below do not reflect this yet. See [Deal Flow Tables](/guides/open-work/deal-flow-v1/deal-flow-tables), decision T7.
</Note>
