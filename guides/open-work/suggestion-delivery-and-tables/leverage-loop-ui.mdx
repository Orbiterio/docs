...
description: "The Midnight Leverage Loop design: open and closed states, introduction and contact drafts, and a complete HTML/CSS reference."
icon: "arrows-rotate"
mode: "wide"
---

This is the current **Ethan Jacks / Katelyn Gallanty** Leverage Loop design, captured on September 14, 2026. It uses the supplied Match Card content with the **Midnight** palette and shared styles from [Outcome UI](/guides/open-work/suggestion-delivery-and-tables/outcome-ui).

[Open the editable design](http://localhost:3003/) · [Sample Leverage Loop payload](/guides/open-work/suggestion-delivery-and-tables/sample-suggestion-data#leverage-loop)

## Default view

Ethan’s match starts open with his profile, the WHY headline and four paragraphs, and the top action: **Double Opt-In Warm Introduction**. The action alternatives and the Rebekah and Bilawal match bars start closed.

<Frame caption="Default state — WHY visible and the top introduction action shown.">
  <img src="/images/suggestion-delivery/leverage-loop-ui/01-default.png" alt="Leverage Loop suggestion for introducing Ethan Jacks to Katelyn, with a Midnight blue WHY panel and collapsed action alternatives." />
</Frame>
...
| --- | --- | --- |
| Ethan match | Leverage Loop badge and match title | Ethan profile, WHY, and Action |
| Action chevron | Double Opt-In Warm Introduction | Email and Text options for both Ethan and Katelyn |
| Make Intro | No composer | Ask Katelyn, Ask Ethan, and Introduction draft steps |
| Draft Email | No composer | Subject and message with **Send** on the right |
| Draft SMS | No composer | Message with **QRCODE** on the right |
| Rebekah and Bilawal bars | Match title | Profile image and placeholder match notes |

WHY stays open within the match; it has no separate chevron. Closing Ethan’s match hides its content. Closing a draft returns to the action bars, and edits remain available until refresh.

### Match

<Tabs>
  <Tab title="Closed">
<Frame caption="Ethan’s match collapsed to its badge and title.">
  <img src="/images/suggestion-delivery/leverage-loop-ui/02-match-closed.png" alt="Collapsed Ethan Jacks match above the Rebekah and Bilawal match bars." />
</Frame>
  </Tab>
  <Tab title="Open — default">
<Frame caption="Ethan’s match open; action alternatives closed.">
  <img src="/images/suggestion-delivery/leverage-loop-ui/01-default.png" alt="Expanded Ethan Jacks match showing profile, WHY, and the primary introduction action." />
</Frame>
  </Tab>
</Tabs>
...
The chevron reveals four options in this order: **Email Ethan Jacks**, **Text Ethan Jacks**, **Email Katelyn Gallanty**, and **Text Katelyn Gallanty**.

<Tabs>
  <Tab title="Closed — top action">
<Frame caption="The primary introduction action stays visible.">
  <img src="/images/suggestion-delivery/leverage-loop-ui/01-default.png" alt="Action alternatives closed with only Double Opt-In Warm Introduction shown." />
</Frame>
  </Tab>
  <Tab title="Open — all alternatives">
<Frame caption="Email and SMS actions for both people.">
  <img src="/images/suggestion-delivery/leverage-loop-ui/03-actions-open.png" alt="Expanded action options showing email and text buttons for Ethan Jacks and Katelyn Gallanty." />
</Frame>
  </Tab>
</Tabs>
...
**Make Intro** opens three editable email drafts. Ask each person first, then use the introduction draft after both agree to connect. Each step includes a subject, a message, and a right-aligned **Send** button.

Each draft also shows its email recipient. Ask Katelyn and Ask Ethan use their respective email arrays; the final introduction shows one recipient field for each person. Each field defaults to the first email and becomes a dropdown when that person has multiple options.

<Tabs>
  <Tab title="Ask Katelyn">
<Frame caption="Step 1 — ask Katelyn about meeting Ethan.">
  <img src="/images/suggestion-delivery/leverage-loop-ui/04-intro-ask-katelyn.png" alt="Introduction composer on Ask Katelyn with an editable email and Send button on the right." />
</Frame>
  </Tab>
  <Tab title="Ask Ethan">
<Frame caption="Step 2 — ask Ethan about meeting Katelyn.">
  <img src="/images/suggestion-delivery/leverage-loop-ui/05-intro-ask-ethan.png" alt="Introduction composer on Ask Ethan with an editable email and Send button on the right." />
</Frame>
  </Tab>
  <Tab title="Introduction">
<Frame caption="Step 3 — introduce them after both agree.">
  <img src="/images/suggestion-delivery/leverage-loop-ui/06-introduction.png" alt="Introduction draft connecting Katelyn and Ethan with the consent reminder and a right-aligned Send button." />
</Frame>
  </Tab>
</Tabs>
...
Email drafts show **Send** on the right. SMS drafts show **QRCODE** on the right. There is no Copy draft button in either composer. The current prototype presents these controls; sending email and generating QR codes are not connected.

Email uses the ordered `params.emails[]` array; SMS uses `params.mobile_phones[]` in E.164 format. The first option is selected initially. A single value is shown as a fixed field; multiple values use a dropdown. Ethan and Katelyn currently have one option each. The [Outcome UI recipient examples](/guides/open-work/suggestion-delivery-and-tables/outcome-ui#recipient-options) show Kyle’s multiple email and mobile options. See [Sample Suggestion Data](/guides/open-work/suggestion-delivery-and-tables/sample-suggestion-data#recipient-options) for the exact values and introduction recipient structure.

<Tabs>
  <Tab title="Ethan email">
<Frame caption="Email to Ethan — Send on the right.">
  <img src="/images/suggestion-delivery/leverage-loop-ui/07-ethan-email.png" alt="Email to Ethan Jacks with Subject and Message fields and a right-aligned Send button." />
</Frame>
  </Tab>
  <Tab title="Ethan SMS">
<Frame caption="Text Ethan — QRCODE on the right.">
  <img src="/images/suggestion-delivery/leverage-loop-ui/08-ethan-sms.png" alt="SMS draft addressed to Ethan Jacks with a right-aligned QRCODE button." />
</Frame>
  </Tab>
  <Tab title="Katelyn email">
<Frame caption="Email to Katelyn — Send on the right.">
  <img src="/images/suggestion-delivery/leverage-loop-ui/09-katelyn-email.png" alt="Email to Katelyn Gallanty with Subject and Message fields and a right-aligned Send button." />
</Frame>
  </Tab>
  <Tab title="Katelyn SMS">
<Frame caption="Text Katelyn — QRCODE on the right.">
  <img src="/images/suggestion-delivery/leverage-loop-ui/10-katelyn-sms.png" alt="SMS draft addressed to Katelyn Gallanty with a right-aligned QRCODE button." />
</Frame>
  </Tab>
</Tabs>
...
Rebekah Jefferis and Bilawal Sidhu each open to their supplied profile image and a notes field. Their match narratives have not been provided; their closed states appear in the default screenshot.

<Frame caption="Rebekah and Bilawal expanded, with Ethan’s match closed.">
  <img src="/images/suggestion-delivery/leverage-loop-ui/11-other-matches-open.png" alt="Rebekah Jefferis and Bilawal Sidhu match bars expanded to profile images and placeholder notes fields." />
</Frame>
...
| --- | --- | --- | --- |
| Page | `#080a0b` | — | — |
| Header and profile card | `#0e1420` | `#202d47` | — |
| WHY | `#172440` | `#7899da` | `#adc9ff` |
| Action | `#14323b` | `#3e7380` | `#b0dce3` |
| Action alternative | `#10252c` | `#3e7380` | `#b0dce3` |

WHY uses a 1px outline on all four edges, a bold headline with a short underline, and 16px by 18px internal padding. Content sections use a 10px top gap. The styles are shared with Outcome in `SuggestionStyles.jsx` and `palettes.js` and include responsive rules.

## Copyable HTML file

[Download the HTML and image bundle (ZIP)](/images/suggestion-delivery/leverage-loop-ui-reference.zip), extract it, and open `leverage-loop-ui-reference.html` in a browser. Keep the `leverage-loop-assets` folder beside the HTML file. The code below is identical to the HTML in the download.

The file contains the board’s HTML, CSS, and plain JavaScript for accordions, editable content, and local draft composers. It needs no React runtime or build step. The prototype toolbar is omitted; the suggestion board is preserved. Send and QRCODE remain preview controls, as in the editable design.

<Accordion title="Complete HTML / CSS reference — copy this block" icon="code">

{/* LEVERAGE_REFERENCE_START */}
...
<head>
  ...
  @media (prefers-reduced-motion: reduce) { #orbiter-moonshot * { transition: none !important; } }
      ...
      #orbiter-moonshot { --orb-reference:none; padding:0; }
...
<div id="orbiter-moonshot" style="--orb-why:#172440;--orb-why-border:#7899da;--orb-why-accent:#adc9ff;--orb-trajectory:#271f32;--orb-trajectory-border:#5c466a;--orb-trajectory-accent:#ceb5e0;--orb-sequencing:#292316;--orb-sequencing-border:#635334;--orb-sequencing-accent:#d8bb7a;--orb-action:#14323b;--orb-action-border:#3e7380;--orb-action-accent:#b0dce3;--orb-action-button:#1a424b;--orb-action-option:#10252c" aria-label="Leverage Loop suggestion board">
<div class="orb-frame">
<div class="loop-context">
<img src="./leverage-loop-assets/katelyn.png" alt="Katelyn Gallanty"/>
<p>Find people in my network to introduce to <strong>Katelyn Gallanty</strong>
</p>
</div>
<article class="orb-opportunity">
<header class="orb-header">
<span class="orb-badge">
<span aria-hidden="true">⟳</span> LEVERAGE LOOP</span>
<h2 class="orb-heading" contentEditable="false">Introduce Ethan Jacks to Katelyn</h2>
<button class="orb-collapse" type="button" aria-expanded="true" aria-controls="loop-main" aria-label="Collapse Ethan Jacks match">
<span class="sample-chevron sample-chevron-up" aria-hidden="true">
</span>
</button>
</header>
<div class="sample-content" id="loop-main">
<article class="orb-person" aria-label="Ethan Jacks profile">
<div class="orb-person-head">
<img class="orb-avatar" src="./leverage-loop-assets/ethan.png" alt="Ethan Jacks"/>
<div class="orb-person-copy">
<h3 contentEditable="false">Ethan Jacks</h3>
<p class="orb-role" contentEditable="false">Managing Partner @ Mediabridge Capital</p>
</div>
<img class="orb-logo" src="./leverage-loop-assets/mediabridge.png" alt="MediaBridge Capital Advisors"/>
</div>
<p class="orb-bio loop-bio">
<span contentEditable="false">Ethan Jacks is Co-founder and Managing Partner of MediaBridge Capital Advisors LLC, where he leads strategic advisory services in media and technology sectors with over 30 years of experience.</span>
</p>
<button class="orb-more" type="button" aria-label="Edit Ethan Jacks profile" aria-pressed="false">•••</button>
</article>
...
<h4 class="orb-why-headline" contentEditable="false">Katelyn&#x27;s founder clients mature into Ethan&#x27;s media-tech M&amp;A pipeline.</h4>
<p contentEditable="false">Katelyn and Ethan would be ideal referral partners across the full company lifecycle — she raises capital for founders pre-seed through Series B at Grant Drive Group, and he runs M&amp;A and exits for media and technology operators at MediaBridge.</p>
<p contentEditable="false">Her clients who are ready to sell become his deals; companies in his pipeline that need a raise before an exit are perfect for her. And Orbiter.io, where she&#x27;s CFO, is built for exactly the media and tech operators in his network.</p>
<p contentEditable="false">They&#x27;d also genuinely like each other. Both walked away from institutional careers — her eight years at Citi, his law partnership and Avid C-suite run — to build boutique, founder-led shops. Both lead with trust over transactions: her line about people needing to know how much you care matches his belief that long-standing relationships drive outcomes. Both spend their LinkedIn celebrating clients rather than themselves.</p>
<p contentEditable="false">Katelyn gets a warm door into media-tech operators who are literal Orbiter target users, plus a specialist she can send sell-side referrals. Ethan gets first look at Orbiter as a deal-sourcing tool, a steady feed of pre-exit founders, and a credible capital-raising partner for clients stuck below the $10M revenue line his firm targets.</p>
</div>
</section>
<section class="orb-section sample-action-section" aria-labelledby="loop-action">
<h3 class="orb-section-title" id="loop-action">
...
<p contentEditable="false">Double Opt-In Warm Introduction</p>
<div class="orb-action-controls">
<button class="orb-draft-button" type="button" data-draft="intro" aria-label="Make introduction" aria-expanded="false" aria-controls="loop-composer">MAKE INTRO</button>
<button class="orb-collapse orb-action-toggle" type="button" aria-label="Show more actions for Ethan Jacks" aria-expanded="false" aria-controls="loop-action-options">
<span class="sample-chevron" aria-hidden="true">
</span>
</button>
</div>
</div>
<div class="orb-action-options" id="loop-action-options" hidden="">
<div class="orb-action orb-action-option">
<p>Email Ethan Jacks</p>
<button class="orb-draft-button" type="button" data-draft="email" aria-label="Draft email to Ethan Jacks" aria-expanded="false" aria-controls="loop-composer">DRAFT EMAIL</button>
</div>
<div class="orb-action orb-action-option">
<p>Text Ethan Jacks</p>
<button class="orb-draft-button" type="button" data-draft="sms" aria-label="Draft SMS to Ethan Jacks" aria-expanded="false" aria-controls="loop-composer">DRAFT SMS</button>
</div>
<div class="orb-action orb-action-option">
<p>Email Katelyn Gallanty</p>
<button class="orb-draft-button" type="button" data-draft="katelyn-email" aria-label="Draft email to Katelyn Gallanty" aria-expanded="false" aria-controls="loop-composer">DRAFT EMAIL</button>
</div>
<div class="orb-action orb-action-option">
<p>Text Katelyn Gallanty</p>
<button class="orb-draft-button" type="button" data-draft="katelyn-sms" aria-label="Draft SMS to Katelyn Gallanty" aria-expanded="false" aria-controls="loop-composer">DRAFT SMS</button>
</div>
</div>
</div>
</div>
...
<button class="orb-more" type="button" aria-label="Edit match" aria-pressed="false">•••</button>
</article>
<section class="orb-collapsed" aria-label="Rebekah Jefferis match">
<button class="orb-summary" type="button" aria-expanded="false" aria-controls="loop-rebekah">
<span>Introduce Rebekah Jefferis to Katelyn</span>
<span class="sample-arrow-circle">
<span class="sample-chevron" aria-hidden="true">
</span>
</span>
</button>
<div class="loop-other-content" id="loop-rebekah" hidden="">
<div class="loop-other-person">
<img class="orb-avatar" src="./leverage-loop-assets/rebekah.png" alt="Rebekah Jefferis"/>
<strong>Rebekah Jefferis</strong>
</div>
<div class="orb-notes">
<label for="loop-notes-rebekah">Match notes</label>
<textarea id="loop-notes-rebekah" rows="3" placeholder="Add the WHY for introducing Rebekah Jefferis to Katelyn…">
</textarea>
</div>
</div>
<button class="orb-more" type="button" aria-label="Edit Rebekah Jefferis notes">•••</button>
</section>
<section class="orb-collapsed" aria-label="Bilawal Sidhu match">
<button class="orb-summary" type="button" aria-expanded="false" aria-controls="loop-bilawal">
<span>Introduce Bilawal Sidhu to Katelyn</span>
<span class="sample-arrow-circle">
<span class="sample-chevron" aria-hidden="true">
</span>
</span>
</button>
<div class="loop-other-content" id="loop-bilawal" hidden="">
<div class="loop-other-person">
<img class="orb-avatar" src="./leverage-loop-assets/bilawal.png" alt="Bilawal Sidhu"/>
<strong>Bilawal Sidhu</strong>
</div>
<div class="orb-notes">
<label for="loop-notes-bilawal">Match notes</label>
<textarea id="loop-notes-bilawal" rows="3" placeholder="Add the WHY for introducing Bilawal Sidhu to Katelyn…">
</textarea>
</div>
</div>
<button class="orb-more" type="button" aria-label="Edit Bilawal Sidhu notes">•••</button>
</section>
</div>
</div>
</div>
...
{/* LEVERAGE_REFERENCE_END */}

</Accordion>

Run `npm run dev:leverage` from `design/suggestion-delivery` for the live prototype. Run `npm run reference:leverage` to regenerate the HTML, ZIP, and this code block after design changes; refresh the screenshots separately.
