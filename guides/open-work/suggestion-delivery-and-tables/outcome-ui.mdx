...
Email drafts include a subject and message. SMS drafts include a message only. Closing a draft returns to the action bars; edited text remains available during the current session. These controls prepare and copy local sample text.
