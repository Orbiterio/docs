...
[Add Required Entities](/guides/open-work/suggestion-delivery-and-tables/add-required-entities) lists the five people and one company whose entity IDs are needed for the sample packages, with LinkedIn references and missing identity links.
