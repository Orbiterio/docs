...
[Sample Suggestion Data](/guides/open-work/suggestion-delivery-and-tables/sample-suggestion-data) contains the current design reference and the leverage loop and outcome example payloads.

<CardGroup cols={2}>
  <Card title="Leverage Loop UI" icon="arrows-rotate" href="/guides/open-work/suggestion-delivery-and-tables/leverage-loop-ui">
    UI reference for contact-centered introductions.
  </Card>
  <Card title="Outcome UI" icon="bullseye" href="/guides/open-work/suggestion-delivery-and-tables/outcome-ui">
    Current Midnight design, open and closed states, and copyable HTML/CSS.
  </Card>
</CardGroup>
