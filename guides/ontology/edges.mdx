...
| `SOUNDTRACK_FOR` / `USED_IN` | Exact music endpoint plus game relation; soundtrack/work/recording kind and scoped usage records as `usage_record_ids` | Music/game bridge replay; named composer or an album track list alone cannot establish the bridge |
