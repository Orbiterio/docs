...
**Official awards:** [The Game Awards adapter](/guides/open-work/video-game-waterfall-game-awards) feeds game recognition and named recipient edges. Each recipient links to their own nominee entry; a shared game or billed company does not make everyone a winner. Performance/music participation is a separate elected credit claim.
...
| `HAS_AWARD` | Game associated with a resolved ceremony/category/nominee entry; required non-empty `award_evidence_record_ids` plus the common envelope. [Complete node and edge example](/guides/open-work/video-game-waterfall-game-awards#complete-award-node-and-game-edge) | Game recognition replay; the game is context for a named-person award, not a claim every contributor won |
...
The [complete example and its source records](/guides/open-work/video-game-waterfall-game-awards#complete-award-node-and-game-edge) remain synchronized with the JSON fixture. No individual recipient edge is inferred for this game-only entry. Award artwork is a resolved game media reference, with no new artwork edge or upload.
