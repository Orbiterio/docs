...
**Pattern:** `Person → APPEARED_IN → Entity:MediaAppearance`. **Identity:** one canonical person/appearance membership. **Writer:** proposed media facts-elected replay. Multiple supporting sources or roles enrich this membership; they do not create duplicate edges.
