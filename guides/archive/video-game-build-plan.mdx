---
title: "Video Game Build Plan"
sidebarTitle: "Video Game Build Plan"
description: "Archived Go/GCP build plan for the video game waterfall: entry-point decisions, execution and queue contracts, source review, locked node and card contracts, acceptance checks and rollout plan."
icon: "box-archive"
---

<Note>
  **Archived 2026-09-13.** This is the build plan the video game waterfall was implemented from, kept for its design rationale, locked contracts and acceptance criteria. The waterfall is now built in `orbiter-universe` (branch `ORBIT-1879/video-game-waterfall`); the developer explanation of what runs today is [Video Game Waterfall](/guides/open-work/video-game-waterfall). Statements below such as "proposed", "still to implement" or "pending" describe the state at planning time, not the current code.
</Note>
